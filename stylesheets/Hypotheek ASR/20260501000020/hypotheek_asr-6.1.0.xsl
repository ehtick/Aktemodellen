...
*************************************************************
Change log;
- [AA-9689] ASR: Het woord "voorts" ontbreekt in de stylesheet
*************************************************************
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:exslt="http://exslt.org/common" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia xsl xlink kef gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_asr-3.0.0.xml')"/>
	...
	<xsl:variable name="partijDerdeHypotheekgeverAanwezig">
		<xsl:choose>
	...
	<xsl:variable name="overbruggingshypotheekAanwezig">
		<xsl:choose>
			<xsl:when test="tia:Bericht_TIA_Stuk/tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']">
				<xsl:text>true</xsl:text>
			</xsl:when>
			<xsl:otherwise>
				<xsl:text>false</xsl:text>
		...
		<table cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					...
					<td>ASR en de Schuldenaar zijn een overeenkomst van geldlening aangegaan, hierna te noemen: de "Overeenkomst van geldlening", van welke overeenkomst blijkt uit een door ASR uitgebracht en door de Schuldenaar geaccepteerd Bindend aanbod. Een afschrift van het door ASR en Schuldenaar ondertekende Bindend aanbod wordt aan deze akte gehecht.</td>
				</tr>
				<tr>
					<td class="number" valign="top">
						<xsl:text>-</xsl:text>
					</td>
					<td>Blijkens de Overeenkomst van geldlening verstrekt ASR aan de Schuldenaar een geldlening voor het hierna te noemen bedrag en is de Schuldenaar verplicht aan ASR de in deze akte omschreven rechten van hypotheek en pand te (doen) verlenen op de wijze en onder de bepalingen en voorwaarden als uiteengezet in deze akte.</td>
				</tr>
				<tr>
					<td class="number" valign="top">
						<xsl:text>-</xsl:text>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<br />
						<xsl:choose>
							<xsl:when test="$overbruggingshypotheekAanwezig='true'">
								<xsl:text>De Schuldenaar verklaarde tevens wegens van ASR ter leen ontvangen gelden hoofdelijk schuldig te zijn aan ASR een bedrag van: </xsl:text>
								<xsl:call-template name="amountText">
								...
								<xsl:text> (hierna te noemen: het "Overbruggingskrediet").</xsl:text>
								<br />
								<xsl:text>ASR verklaarde de hiervoor vermelde schuldbekentenis te aanvaarden.</xsl:text>
								<br />
							</xsl:when>
						...
						<xsl:choose>
							<xsl:when test="$overbruggingshypotheekAanwezig='true'">
								<xsl:text> en het Overbruggingskrediet</xsl:text>
							</xsl:when>
						</xsl:choose>
						<xsl:text>.</xsl:text>
						<br />
						<xsl:text>De Schuldenaar en ASR kunnen overeenkomen dat door ASR aan de Schuldenaar een aanvullende geldlening wordt verstrekt, hierna te noemen: "de aanvullende geldlening". Een aanvullende geldlening wordt alleen verstrekt voor zover het op grond van de voormelde overeenkomst van geldlening en eventuele aanvullende geldlening(en) uitstaande bedrag lager is dan het hierna onder Hypotheekstelling Lening, sub (A) genoemde bedrag en indien aan de op dat moment geldende acceptatiecriteria wordt voldaan.</xsl:text>
						<br />
						<u>
						...
						<br />
						<xsl:text>De Schuldenaar is rente over de Lening tegen het in de Overeenkomst van geldlening overeengekomen rentepercentage verschuldigd. De voor het eerst te betalen rente wordt berekend vanaf de datum waarop ASR het bedrag van de Lening ter beschikking heeft gesteld aan de Schuldenaar tot de laatste dag van de desbetreffende maand. Voor iedere volgende maand wordt de door de Schuldenaar te betalen rente berekend over het Uitstaande Bedrag per het einde van de daaraan voorafgaande maand.</xsl:text>
						<br />
						<u>
						...
						<xsl:choose>
							<xsl:when test="$overbruggingshypotheekAanwezig='true'">
								...
								<br />
								<xsl:text>In de Overeenkomst van geldlening is overeengekomen dat ASR, ter overbrugging van de periode tussen de koop van de nieuwe Woning en de verkoop van de bestaande Woning aan de Schuldenaar een tijdelijke Lening verstrekt, het Overbruggingskrediet. Zie hiervoor en de Hypotheekstelling Overbruggingskrediet. Het Overbruggingskrediet heeft een looptijd zoals in de Overeenkomst van geldlening is overeengekomen, dan wel eventueel nader tussen partijen (zal worden) overeengekomen. De Schuldenaar is rente over het Overbruggingskrediet tegen het in de Overeenkomst van geldlening overeengekomen rentepercentage verschuldigd.</xsl:text>
							</xsl:when>
						</xsl:choose>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<br />
						<xsl:text>De (Derde) Hypotheekgever verleent tot zekerheid aan ASR, die bij deze van de (Derde) Hypotheekgever aanvaardt, voor de betaling van de Lening en al hetgeen ASR in verband daarmee te vorderen mocht hebben of krijgen op grond van de Overeenkomst van geldlening, eventueel nog te verstrekken aanvullende geldlening(en), de betaling van de verschuldigde rente (ook indien deze betrekking heeft op een periode van langer dan drie jaar) en in de Algemene Voorwaarden bedoelde kosten, vergoedingen en premies voor verzekeringen of inleg voor bankrekeningen een recht van hypotheek </xsl:text>
					...
					<xsl:when test="$overbruggingshypotheekAanwezig='true'">
						<tr>
							...
							<td>
								...
								<br />
								<xsl:text>Daarnaast verleent de (Derde) Hypotheekgever tot zekerheid aan ASR, die bij deze van de (Derde) Hypotheekgever aanvaardt, tot zekerheid voor de betaling van al hetgeen ASR te vorderen mocht hebben of krijgen op grond van het Overbruggingskrediet, de betaling van de verschuldigde rente (ook indien deze betrekking heeft op een periode van langer dan drie jaar), in de Algemene Voorwaarden bedoelde kosten en vergoedingen, een recht van hypotheek </xsl:text>
									...
									<tbody>
										...
										<tr>
											...
											<td valign="top">
												<xsl:text>de hiervoor bedoelde rente, kosten, vergoedingen en premies en/of inleg, die tezamen worden begroot op veertig procent (40%) van het onder a omschreven bedrag, zijnde </xsl:text>
												<xsl:call-template name="amountText">
													<xsl:with-param name="amount" select="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']/tia:bedragRente/tia:som"/>
													<xsl:with-param name="valuta" select="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']/tia:bedragRente/tia:valuta"/>
												</xsl:call-template>
												<xsl:text> </xsl:text>
												<xsl:call-template name="amountNumber">
													<xsl:with-param name="amount" select="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']/tia:bedragRente/tia:som"/>
						...
						<td valign="top"><xsl:apply-templates select="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']" mode="do-overbruggingshypotheek"/>
						</td>
					</tr><tr>
						<td class="number" valign="top">
							<xsl:text>&#xFEFF;</xsl:text>
	...
	*********************************************************
	...
	Description: ASR mortgage deed rights.
	...
	*********************************************************
	...
	Description: ASR mortgage deed free text part.
													...
													<tbody>
														<tr>
															...
															<td>
																...
																<xsl:choose>
																	<xsl:when test="$partijDerdeHypotheekgeverAanwezig='true'">
																		<xsl:text>;</xsl:text>
																	</xsl:when>
																	<xsl:otherwise>
																		<xsl:text>.</xsl:text>
	...
	*********************************************************
	...
	Description: ASR mortgage deed party persons.
