...
Binnenkort zullen we wel een nieuwe stylesheet van de ING opleveren die gebaseerd zal zijn op de versie 20250101000004 van de ING. 

## 2 april 2026
In deze release:
- nieuwe stylesheet 20250301000021-impl_2 van de Lloyds opgeleverd. 
- nieuwe waardelijst BRPland is per 1 april 2026 aktief.
...
In deze release hebben we stylesheetnummer 20260115000015 voor de Aegon opgeleverd. Deze is gebasseerd op bankmodel Aegon 25.03.
...
- Voor de Rabobank is er een nieuwe versie van de RabobankHypotheekakte XSD opgeleverd. Hiervoor is een nieuw stylesheetnummer opgeleverd. De details vind u in het [**changelog**](/schema/RabobankHypotheekakte);
- Voor de Particuliere hypotheek is er een nieuwe versie van de ParticuliereHypotheek XSD opgeleverd. Hiervoor is een nieuw stylesheetnummer opgeleverd. De details vind u in het [**changelog**](/schema/ParticuliereHypotheekakte);
...
Met deze release hebben we een bug opgelost in de Aegon. Hiervoor is een nieuw stylesheetnummer opgeleverd: 20251001000015. De details vind u in de [**release notes**](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Aegon/20251001000015/Releasenotes%20Aegon%20251001000015%20-%201.md).

## 11 september 2025

Met deze release hebben we een bug opgelost in de Obvion. Hiervoor is een nieuw implementatienummer opgeleverd: 20250201000012-implnr 2. De details vind u in de [**release notes**](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Obvion/20250201000012/Releasenotes%20Obvion%2020250201000012%20-%202.md).

## 14 augustus 2025

- Nieuw stylesheet van de Neo opgeleverd op basis van een nieuwe versie van het bankmodel. De [**release notes**](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Neo/20250801000032/Releasenotes%20Neo%20Hypotheken%2020250801000032%20-%201.md) vindt u hier. Deze versie van de Neo is een bèta versie.
...
2. In het tekstblok Partijnamen in hypotheekakten hebben we een bevinding opgelost. De details van deze aanpassing vindt u in de genoemde releasenotes.
...
De documentatie vindt u [**hier**](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Svenska%20Handelsbanken/20241025000035).

## 22 oktober 2024

Voor de Aegon is een nieuwe stylesheet opgeleverd. Dit bankmodel is de Stater versie. In de loop van januari 2025 kan dit model ter inschrijving worden aangeboden bij het Kadaster. Nadere info volgt. Deze versie van de Aegon is een bèta versie. Indien er bevindingen zijn op deze akte dan zal dit resulteren in een nieuw implementatienummer of een nieuw stylesheetnummer.
De documentatie vindt u [**hier**](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Aegon/20241001000015).

## 3 oktober 2024

Met deze release hebben we een nieuw generiek model geïntroduceerd: Stater generiek. Dit model kan vanaf nu alleen gebruikt worden voor het label 'Vandaag Hypotheken'. In de toekomst zullen hier meerdere labels aan toegevoegd gaan worden. De documentatie vindt u [**hier**](kik-modeldocumenten/modeldocumenten/Hypotheek%20Stater%20generiek/2024090100034)
...
Vanaf vandaag zijn de volgende stylesheetnummers geen bèta versie meer:

- Verdeling 20231016000009
- Notariele Verklaring 20231016000008
- Levering 20231016000007
- Levering 20231020000007

Vanaf 22 december is de Aegon, met stylesheetnummer 20231105000015, geen bèta versie meer.

Wijzigingen op de genoemde stylesheetnumers zullen vanaf dan resulteren in een nieuw stylesheetnummer of implementatienummer.
...
Nieuw bankmodel Aegon opgeleverd. De documentatie vindt u [**hier**](kik-modeldocumenten/modeldocumenten/Hypotheek%20Aegon/20231105000015). Deze versie van de Aegon is een bèta versie. De onvolkomenheden die we de komende 4 weken vinden, zullen we nog in deze versie oplossen en uiteindelijk definitief verklaren;

## 3 november 2023

De stylesheet van de NIBC (20231002000027) is vanaf heden geen bèta versie meer. Wijzigingen op deze stylesheet zullen vanaf nu resulteren in een nieuw stylesheetnummer of implementatienummer.
...
In de betreffende releasenotes vindt u verdere informatie. De versienummers van de stylesheets en de toelichting zijn niet aangepast omdat dit beide een bèta versie betreft.
...
In deze release is een nieuwe versie van de toelichting van de Triodos gepubliceerd. In de [release notes](kik-modeldocumenten/modeldocumenten/Hypotheek%20Triodos/20230401000030/Releasenotes%20Triodos%2020230401000030-%201.md) kunt u zien wat er is gewijzigd.
...
3. **Reminder:** _Vanaf 1-3-2022 kunnen de stylesheetnummers die beginnen met 2018 niet meer aangeboden worden._
...
4. **Reminder:** _Vanaf 1-3-2022 kunnen de stylesheetnummers die beginnen met 2018 niet meer aangeboden worden._
...
2. Nieuw implementatienummer voor Syntrus Achmea.
   - De details van de wijziging staan in de [release notes](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Syntrus%20Achmea/20200907000022/Releasenotes%20Syntrus%20Achmea%2020200907000022%20-%202.md).  

3. Voor de Lot hypotheek hebben we een tekstuele aanpassing gedaan. Dit hebben we in de huidige versie van de stylesheet aangepast.
   - De details van de wijziging staan in de [release notes](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Lot/20210501000026/Releasenotes%20Lot%2020210501000026%20-%201.md).
   Met deze release wordt de bèta versie van de Lot definitief gemaakt.

4. Het Vista model, met stylesheetnummer 20200602500024, is per 1 juli 2021 uitgezet.

## 4 juni 2021

1. Bèta versie nieuw bankmodel van Lot Hypotheken;

   - Het modeldocument en de toelichting van Lot Hypotheken staan in de [documentatiemap](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Lot/20210501000026).

2. Gewijzigde versie van het bankmodel ASR;
   - De details van de wijziging van ASR staan in de [release notes](/kik-modeldocumenten/modeldocumenten/Hypotheek%20ASR/20210511000020/Releasenotes%20ASR%2020210511000020%20-%201.md).

3. Voor de Argenta hebben we een bug opgelost. Met deze release wordt de bèta versie van de Argenta definitief gemaakt;
   - De details van de wijziging van Argenta staan in de [release notes](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Argenta/20210215000025/Releasenotes%20Argenta%2020210215000025-%201.md) .

4. Per 1 juli 2021 zullen we het model van Vista, met stylesheetnummer 20200602500024, definitief uitzetten. Zie eerdere release notes van 19 november 2021.
...
- De hoofdletter van de verschillende rechtsvormen is aangepast naar een kleine letter, met uitzondering van de waarden die "Europees", "Europese", "Kerkgenootschap" en "de Staat" bevatten.

- De waarde "Publiekrechtelijk rechtspersoon" is gewijzigd naar "publiekrechtelijke rechtspersoon".

Deze waardelijst aanpassingen zijn op 17 december jongstleden aangekondigd.
...
Met deze release wordt de bèta release betreffende de hypotheekakte van Argenta definitief gemaakt. Vanaf nu resulteren wijzigingen aan deze akte in een nieuw stylesheetnummer of een nieuw implementatienummer.
...
- Op verzoek nummering toegevoegd voor vaste tekst in de hypotheekakte van Syntrus Achmea. Details van deze wijziging zijn te vinden in de [release notes](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Syntrus%20Achmea/20190701000022/Releasenotes%20Syntrus%20Achmea%2020190701000022%20-%204.md).
- Voor de Doorhaling hypotheek hebben we de nummering van de comparitie op enkele punten aangepast. Details zijn te vinden in de [release notes](/kik-modeldocumenten/modeldocumenten/Doorhaling%20hypotheek/20190826000010/Releasenotes%20Doorhaling%20hypotheek%2020190826000010%20-%202.md).
- Over 4 weken worden de volgende depotnummers definitief uitgezet:
...
- De ABP en de Obvion maakte gebruik van de zelfde stylesheet. Voor de Obvion hebben we nu een eigen versie van de stylesheet aangemaakt. Straks bij het aanpassen van de ABP krijgt deze ook een eigen versie van de stylesheet.
